  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-3 px-4 py-2 bg-gray-900/60 border border-gray-800 rounded-xl hover:bg-gray-800 transition-all duration-200"
      >
      ...
      {isOpen && (
        <>
          ...
          <div
            className={`absolute top-full right-0 mt-2 w-80 max-w-xs card-dark z-50 overflow-hidden ${dropdownClassName || "left-auto"}`}
          >
