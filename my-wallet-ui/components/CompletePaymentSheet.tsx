		...
		<div className="fixed inset-0 z-30 flex items-center justify-center p-4">
			...
			<div className="relative w-full max-w-md card-dark border-blue-900/40">
				...
				<div className="px-6 pb-6 space-y-6">
					...
					<p className="text-center text-gray-400">{t('buy.securePaymentProcessing')} <span className="text-blue-300 font-medium">${amountUsd.toFixed(2)} {currency}</span></p>
					...
					<div className="card-dark p-4">
						<p className="text-emerald-400">{t('buy.securePayment')}</p>
